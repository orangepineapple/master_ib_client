...
from main import start_scanner_service
...
def run_catchup():
    ...
    if is_weekday and is_after_open and is_before_close:
        runner(func=start_scanner_service, name="IB Scanner Service")
...
scheduler.add_job(
    ...
    hour=9, 
    minute=0, 
    kwargs={"func" : start_scanner_service, 
            "name" : "IB Scanner Service"},
    id="scanner service start"
)
